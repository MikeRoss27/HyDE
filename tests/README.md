...
| `test_waybar_pins.sh` | Dynamic application pins detect running windows, persist unpins, and are injected before direct or grouped Waybar taskbars without duplicates |
